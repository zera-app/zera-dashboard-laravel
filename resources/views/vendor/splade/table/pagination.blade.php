<nav role="navigation" aria-label="{{ __('Pagination Navigation') }}"
    class="flex items-center justify-between px-4 sm:px-0 py-3">
    <div class="flex justify-between flex-1 md:hidden">
        @if ($paginator->onFirstPage())
        <span
            class="relative inline-flex items-center px-4 py-2 text-xs sm:text-sm font-medium text-gray-500 bg-base-100 border border-base-300 cursor-default leading-5 rounded-md">
    ...
    <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
        <div class="flex items-center">
            ...
            <div class="hidden lg:block @if($hasPerPageOptions ?? true) ml-3 @endif">
                <p class="text-xs sm:text-sm text-base-content leading-5">
        ...
        <div>
            <span class="relative z-0 inline-flex shadow-sm rounded-md">
                ...
                <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                    <span
                        class="relative inline-flex items-center px-2 py-2 text-xs sm:text-sm font-medium text-gray-500 bg-base-100 border border-base-300 cursor-default rounded-l-md leading-5"
                        aria-hidden="true">
                ...
                <span aria-disabled="true">
                    <span
                        class="relative inline-flex items-center px-4 py-2 -ml-px text-xs sm:text-sm font-medium text-base-content bg-base-100 border border-base-300 cursor-default leading-5">{{
                        $element }}</span>
                </span>
                @endif
                ...
                <span aria-disabled="true" aria-label="{{ __('pagination.next') }}">
                    <span
                        class="relative inline-flex items-center px-2 py-2 -ml-px text-xs sm:text-sm font-medium text-gray-500 bg-base-100 border border-base-300 cursor-default rounded-r-md leading-5"
                        aria-hidden="true">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                                d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
