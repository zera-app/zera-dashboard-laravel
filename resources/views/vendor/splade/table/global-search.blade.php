<div class="relative">
    <input
        class="block bg-base-100 text-base-content w-full sm:pl-9 text-sm rounded-md shadow-sm focus:ring-secondary-focus focus:border-secondary-focus border border-base-300 "
