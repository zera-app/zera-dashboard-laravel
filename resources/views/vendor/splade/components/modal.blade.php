<x-splade-component is="modal-wrapper" :base-attributes="$attributes->except('class')" :key="$modalKey"
    :close-button="$closeButton" :close-explicitly="$closeExplicitly" :name="$name">
    ...
    <div class="fixed inset-0 z-40 overflow-y-auto p-4">
        ...
        <div class="flex min-h-full justify-center" v-bind:class="{
            ...
            <x-splade-component is="transition" child animation="fade" after-leave="modal.emitClose"
                animate="modal.animate" v-bind:class="{
