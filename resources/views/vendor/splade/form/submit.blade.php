...
<div @class($wrapperClass)>
    <button {{ $attributes->class([
        ...
        'bg-secondary hover:bg-secondary-focus text-white border-transparent focus:border-indigo-300
        ...
        <div class="flex flex-row items-center justify-center">
            <svg v-if="@js($spinner) && form.processing"
                class="animate-spin mr-3 h-5 w-5 @if($secondary) text-gray-700 @else text-white @endif"
