...
${codeFrame}` : message);
    ...
    L[Ia] = L[Pa] = L[qa] = L[Ca] = L[Fa] = L[ka] = L[La] = L[Ba] = L[ja] = true;
    L[ha] = L[ma] = L[_a] = L[va] = L[Aa] = L[ga] = L[ya] = L[ba] = L[wa] = L[Sa] = L[Oa] = L[$a] = L[Ea] = L[Ta] = L[xa] = false;
    function Ma(e) {
    ...
    const Rt = vueExports.ref(0), ie = vueExports.ref(1), B = vueExports.ref({}), ae = vueExports.ref(0), zt = vueExports.ref({}), tt = {}, $e = typeof window > "u";
    function co(e, t, r) {
    ...
    function vo(e, t, r) {
      ...
      const i = Nr.value;
      if (Ur(e.data.splade), Gt(e.data.splade.head), n === B.value.url && (t = true), e.data.splade.modal)
    ...
    const yi = vueExports.ref({}), bi = (e) => yi.value[e], yo = (e) => Object.keys(bi.value[e]).length > 0, wi = vueExports.ref({}), bo = (e) => wi.value[e], Si = vueExports.ref({}), wo = (e) => Si.value[e], rt = vueExports.ref([]);
    function So(e) {
      rt.value.push(e);
    }
    const Oo = vueExports.computed(() => uo(rt.value));
    function $o(e) {
    ...
    function _i(e, t) {
      zt.value[ae.value] = true, Ti.value(e, t);
    }
    function xo(e) {
      return zt.value[e];
    }
    ...
    function qo(e) {
      const t = Wr.value[e];
      return t ? (ae.value++, _i(t.html, t.type), true) : false;
    }
    function Co(e, t, r) {
    ...
    function Bo(e) {
      ...
      return e && (t["X-Splade-Preserve-Scroll"] = true), qi(B.value.url, t);
    }
    function jo(e, t) {
      tt[ie.value].on(e, t);
    }
    ...
    const v = {
      ...
      // ref
      stackType: xo,
      pageVisitId: vueExports.computed(() => B.value.pageVisitId),
      // ref
      dynamicVisitId: vueExports.computed(() => B.value.dynamicVisitId),
      // ref
      isSsr: $e,
    ...
    const ue = {
      ...
      setup(e) {
        ...
        const f = (p, h) => {
          n.value = [], r.value = p, vueExports.nextTick(() => {
            if (!v.isSsr) {
        ...
        return v.setOnHtml((p, h) => {
          ...
          n.value[v.currentStack.value] && (a.value = false), n.value[v.currentStack.value] = { html: p, type: h }, vueExports.nextTick(() => {
            a.value = true;
          });
        ...
        }), (p, h) => (vueExports.openBlock(), vueExports.createElementBlock("div", null, [
          ...
          (vueExports.openBlock(true), vueExports.createElementBlock(vueExports.Fragment, null, vueExports.renderList(vueExports.unref(v).currentStack.value, (d) => (vueExports.openBlock(), vueExports.createBlock(ue, {
            key: `modal.${d}`,
            type: n.value[d].type,
            html: n.value[d].html,
            stack: d,
            "on-top-of-stack": vueExports.unref(v).currentStack.value === d,
            animate: a.value,
            onClose: (b) => c(d)
          }, null, 8, ["type", "html", "stack", "on-top-of-stack", "animate", "onClose"]))), 128)),
          i.value ? (vueExports.openBlock(), vueExports.createBlock(Do, {
            key: 2,
            html: i.value,
            onClose: u
    ...
    function zr(e, t) {
      if (R(e))
        return false;
      var r = typeof e;
      return r == "number" || r == "symbol" || r == "boolean" || e == null || Xt(e) ? true : Go.test(e) || !zo.test(e) || t != null && e in Object(t);
    }
    ...
    function dr({ props: e, attrs: t, slots: r, slot: n, name: i }) {
      ...
      if (n) {
        ...
        for (let [f, p] of Object.entries(n))
          typeof p == "boolean" && (m = true), p === true && g.push(f);
...
`)].join(`
`));
          let f = Li((a = m.props) != null ? a : {}, l), p = vueExports.cloneVNode(m, f);
          for (let h in f)
    ...
    function ki(e) {
      return e.flatMap((t) => t.type === vueExports.Fragment ? ki(t.children) : [t]);
    }
    function Li(...e) {
      if (e.length === 0)
        return {};
    ...
    var Xl = Object.defineProperty, Kl = (e, t, r) => t in e ? Xl(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : e[t] = r, Pn = (e, t, r) => (Kl(e, typeof t != "symbol" ? t + "" : t, r), r);
    class Jl {
      constructor() {
    ...
    function ru(e) {
      var t, r;
      return (r = (t = e == null ? void 0 : e.matches) == null ? void 0 : t.call(e, tu)) != null ? r : false;
    }
    function nu(e, t = (r) => r) {
    ...
    function Lt(e, t, { sorted: r = true, relativeTo: n = null, skipElements: i = [] } = {}) {
      ...
      let l = (() => {
        ...
        if (t & 8)
          return o.length - 1;
        throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
      })(), c = t & 32 ? { preventScroll: true } : {}, m = 0, g = o.length, f;
      do {
        if (m >= g || m + g <= 0)
          return 0;
        let p = u + m;
    ...
    function iu(e, t, r = vueExports.computed(() => true)) {
      function n(s, a) {
    ...
    let pt = Object.assign(vueExports.defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: vueExports.ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
      ...
      vueExports.onMounted(() => a.value = true), vueExports.onUnmounted(() => a.value = false), cu({ ownerDocument: s }, vueExports.computed(() => a.value && !!(e.features & 16)));
      let o = du({ ownerDocument: s, container: i, initialFocus: vueExports.computed(() => e.initialFocus) }, vueExports.computed(() => a.value && !!(e.features & 2)));
      fu({ ownerDocument: s, container: i, containers: e.containers, previousActiveElement: o }, vueExports.computed(() => a.value && !!(e.features & 8)));
      let l = ou();
      function u(f) {
        let p = D(i);
        p && ((h) => h())(() => {
      ...
      return () => {
        ...
        return vueExports.h(vueExports.Fragment, [!!(h & 4) && vueExports.h(wr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Nt.Focusable }), Z({ ourProps: p, theirProps: { ...t, ...O }, slot: f, attrs: t, slots: r, name: "FocusTrap" }), !!(h & 4) && vueExports.h(wr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Nt.Focusable })]);
      };
    } }), { features: Hi }), Ue = [];
    lu(() => {
      function e(t) {
    ...
    function qn(e, t = vueExports.ref(true)) {
    ...
    let Gi = vueExports.defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(e, { slots: t, attrs: r }) {
      let n = vueExports.ref(null), i = vueExports.computed(() => Tt(n)), s = pu(), a = vueExports.inject(Xi, null), o = vueExports.ref(s === true || a == null ? hu(n.value) : a.resolveTarget());
    ...
    } }), Xi = Symbol("PortalGroupContext"), mu = vueExports.defineComponent({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(e, { attrs: t, slots: r }) {
    ...
    function yu() {
      let e = vueExports.inject(Ji, null);
      if (e === null)
        throw new Error("Missing parent");
      return e;
    }
    function bu({ slot: e = vueExports.ref({}), name: t = "Description", props: r = {} } = {}) {
      ...
      return vueExports.provide(Ji, { register: i, slot: e, name: t, props: r }), vueExports.computed(() => n.value.length > 0 ? n.value.join(" ") : void 0);
    }
    vueExports.defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: () => `headlessui-description-${Ye()}` } }, setup(e, { attrs: t, slots: r }) {
      ...
      return vueExports.onMounted(() => vueExports.onUnmounted(n.register(e.id))), () => {
        let { name: i = "Description", slot: s = vueExports.ref({}), props: a = {} } = n, { id: o, ...l } = e, u = { ...Object.entries(a).reduce((c, [m, g]) => Object.assign(c, { [m]: vueExports.unref(g) }), {}), id: o };
    ...
    function xu(e, t, r) {
      let n = wu(He), i = vueExports.computed(() => {
      ...
      return vueExports.watch([e, t], ([s, a], [o], l) => {
        ...
        let u = false;
        l(() => {
          u || (He.dispatch("POP", o ?? s, r), u = true);
        });
      }, { immediate: true }), i;
    }
    ...
    let qt = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Yr = vueExports.defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: qt }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${Ye()}` } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
      var s;
      let a = vueExports.ref(false);
      vueExports.onMounted(() => {
        a.value = true;
      });
      let o = vueExports.ref(0), l = Qr(), u = vueExports.computed(() => e.open === qt && l !== null ? (l.value & G.Open) === G.Open : e.open), c = vueExports.ref(null), m = vueExports.ref(null), g = vueExports.computed(() => Tt(c));
      ...
      let f = vueExports.computed(() => a.value && u.value ? 0 : 1), p = vueExports.computed(() => f.value === 0), h = vueExports.computed(() => o.value > 1), d = vueExports.inject($r, null) !== null, b = vueExports.computed(() => h.value ? "parent" : "leaf"), O = vueExports.computed(() => l !== null ? (l.value & G.Closing) === G.Closing : false), I = vueExports.computed(() => d || O.value ? false : p.value), S = vueExports.computed(() => {
        var E, T, A;
        return (A = Array.from((T = (E = g.value) == null ? void 0 : E.querySelectorAll("body > *")) != null ? T : []).find((C) => C.id === "headlessui-portal-root" ? false : C.contains(D(m)) && C instanceof HTMLElement)) != null ? A : null;
      });
      qn(S, I);
      let $ = vueExports.computed(() => h.value ? true : p.value), w = vueExports.computed(() => {
        var E, T, A;
      ...
      qn(w, $), gu({ type: "Dialog", enabled: vueExports.computed(() => f.value === 0), element: c, onUpdate: (E, T) => {
        if (T === "Dialog")
          return fe(E, { [Or.Add]: () => o.value += 1, [Or.Remove]: () => o.value -= 1 });
      } });
      let _ = bu({ name: "DialogDescription", slot: vueExports.computed(() => ({ open: u.value })) }), q = vueExports.ref(null), P = { titleId: q, panelRef: vueExports.ref(null), dialogState: f, setTitleId(E) {
        q.value !== E && (q.value = E);
      }, close() {
        t("close", false);
      } };
      ...
      let M = vueExports.computed(() => !(!p.value || h.value));
      iu(() => k(), (E, T) => {
        P.close(), vueExports.nextTick(() => T == null ? void 0 : T.focus());
      }, M);
      let U = vueExports.computed(() => !(h.value || f.value !== 0));
      ...
      return xu(g, F, (E) => {
        ...
        let { id: E, open: T, initialFocus: A, ...C } = e, ge = { ...r, ref: c, id: E, role: "dialog", "aria-modal": f.value === 0 ? true : void 0, "aria-labelledby": q.value, "aria-describedby": _.value }, H = { open: f.value === 0 };
        return vueExports.h(Sr, { force: true }, () => [vueExports.h(Gi, () => vueExports.h(mu, { target: c.value }, () => vueExports.h(Sr, { force: false }, () => vueExports.h(pt, { initialFocus: A, containers: k, features: p.value ? fe(b.value, { parent: pt.features.RestoreFocus, leaf: pt.features.All & ~pt.features.FocusLock }) : pt.features.None }, () => Z({ ourProps: ge, theirProps: C, slot: H, attrs: r, slots: n, visible: f.value === 0, features: Dt.RenderStrategy | Dt.Static, name: "Dialog" }))))), vueExports.h(wr, { features: Nt.Hidden, ref: m })]);
      };
    } });
    ...
    vueExports.defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-backdrop-${Ye()}` } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
      ...
      return n({ el: s, $el: s }), vueExports.onMounted(() => {
        ...
        return vueExports.h(Sr, { force: true }, () => vueExports.h(Gi, () => Z({ ourProps: l, theirProps: { ...t, ...o }, slot: { open: i.dialogState.value === 0 }, attrs: t, slots: r, name: "DialogBackdrop" })));
      };
    } });
    let Zr = vueExports.defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-panel-${Ye()}` } }, setup(e, { attrs: t, slots: r, expose: n }) {
    ...
    let Yi = Dt.RenderStrategy, lt = vueExports.defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
      ...
      let c = vueExports.ref(null), m = vueExports.computed(() => e.unmount ? Ce.Unmount : Ce.Hidden);
      i({ el: c, $el: c });
      let { show: g, appear: f } = Cu(), { register: p, unregister: h } = Fu(), d = vueExports.ref(g.value ? "visible" : "hidden"), b = { value: true }, O = Ye(), I = { value: false }, S = Qi(() => {
      ...
      function U(F) {
        ...
        !T || !(T instanceof HTMLElement) || E || (I.value = true, g.value && a(), g.value || l(), F(g.value ? Cn(T, $, w, _, q, (A) => {
          I.value = false, A === Er.Finished && o();
        }) : Cn(T, P, k, M, q, (A) => {
          I.value = false, A === Er.Finished && (Zt(S) || (d.value = "hidden", h(O), u()));
        })));
      }
      return vueExports.onMounted(() => {
      ...
      }), vueExports.provide(tn, S), Gl(vueExports.computed(() => fe(d.value, { visible: G.Open, hidden: G.Closed }) | s.value)), () => {
        let { appear: F, show: E, enter: T, enterFrom: A, enterTo: C, entered: ge, leave: H, leaveFrom: ct, leaveTo: At, ...Ae } = e, Ze = { ref: c }, Ie = { ...Ae, ...f.value && g.value && Et.isServer ? { class: vueExports.normalizeClass([r.class, Ae.class, ...$, ...w]) } : {} };
        return Z({ theirProps: Ie, ourProps: Ze, slot: {}, slots: n, attrs: r, features: Yi, visible: d.value === "visible", name: "TransitionChild" });
      };
    } }), ku = lt, ut = vueExports.defineComponent({ inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n }) {
      let i = Qr(), s = vueExports.computed(() => e.show === null && i !== null ? (i.value & G.Open) === G.Open : e.show);
      vueExports.watchEffect(() => {
      ...
      return vueExports.onMounted(() => {
        ...
        return Z({ ourProps: { ...m, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [vueExports.h(ku, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...m, ...c }, n.default)] }, attrs: {}, features: Yi, visible: a.value === "visible", name: "Transition" });
      };
    } });
    const Lu = {
      props: {
    ...
    function er(e, t, r) {
      var n, i, s, a, o, l, u = 0, c = false, m = false, g = true;
      if (typeof e != "function")
    ...
    function ac(e, t, r) {
      ...
      an(s)) && (o = ic(t)), re(t) ? (l = it(t, true), l.x += t.clientLeft, l.y += t.clientTop) : s && (l.x = sn(s))), {
    ...
    function Jc(e) {
      var t = e.state, r = e.options, n = e.name, i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? false : a, l = r.boundary, u = r.rootBoundary, c = r.altBoundary, m = r.padding, g = r.tether, f = g === void 0 ? true : g, p = r.tetherOffset, h = p === void 0 ? 0 : p, d = ln(t, {
        boundary: l,
        rootBoundary: u,
        padding: m,
        altBoundary: c
    ...
    function rd(e) {
      ...
      if (!t.modifiersData[n]._skip) {
        for (var i = r.mainAxis, s = i === void 0 ? true : i, a = r.altAxis, o = a === void 0 ? true : a, l = r.fallbackPlacements, u = r.padding, c = r.boundary, m = r.rootBoundary, g = r.altBoundary, f = r.flipVariations, p = f === void 0 ? true : f, h = r.allowedAutoPlacements, d = t.options.placement, b = Fe(d), O = b === d, I = l || (O || !p ? [jt(d)] : td(d)), S = [d].concat(I).reduce(function(Ie, Pe) {
    ...
    function ad(e, t, r, n, i, s) {
      ...
      return vueExports.openBlock(), vueExports.createBlock(a, {
        ...
        default: vueExports.withCtx(() => [
          ...
          vueExports.createElementVNode("div", sd, [
    ...
    const ud = {
      ...
      methods: {
        ...
        handlePendingRefresh() {
          this.pendingRefresh && v.currentStack.value === this.stack && (v.refresh(this.pendingRefresh.preserveScroll || this.preserveScroll), this.pendingRefresh = false);
        },
        bindListeners() {
    ...
    function cs(e, t, r, n, i, s) {
      ...
      if (u && c)
        return u == t && c == e;
      var m = -1, g = true, f = r & $d ? new Ut() : void 0;
    ...
    function Qd(e, t, r, n, i, s) {
      ...
      if (h && !d) {
        ...
        S != $ && "constructor" in e && "constructor" in t && !(typeof S == "function" && S instanceof S && typeof $ == "function" && $ instanceof $) && (h = false);
      }
    ...
    function df(e, t, r, n, i, s) {
      ...
      return g ? (s || (s = new Se()), Qd(e, t, r, n, i, s)) : false;
    }
    function ir(e, t, r, n, i) {
      return e === t ? true : e == null || t == null || !Le(e) && !Le(t) ? e !== e && t !== t : df(e, t, r, n, ir, i);
    }
    var ff = 1, pf = 2;
    function hf(e, t, r, n) {
    ...
    function vs(e) {
      return e === true || e === false || Le(e) && je(e) == jf;
    }
    function gs(e, t) {
      var r = {};
...
`));
      ...
      methods: {
        ...
        async request(e) {
          ...
          this.acceptHeader && (r.Accept = this.acceptHeader), (this.stay || e) && (r["X-Splade-Prevent-Refresh"] = true), this.preserveScroll && (r["X-Splade-Preserve-Scroll"] = true), this.stack > 0 && this.keepModal && (r["X-Splade-Modal"] = v.stackType(this.stack), r["X-Splade-Modal-Target"] = this.stack);
          ...
          v.request(this.action, n, t, { ...r, ...this.headers }, false, this.blob).then(i).catch(async (s) => {
    ...
    function Nf(e, t, r, n, i, s) {
      return vueExports.openBlock(), vueExports.createElementBlock("div", Df, [
    ...
    function Wf(e, t, r, n, i, s) {
      return vueExports.openBlock(), vueExports.createElementBlock("div", Hf, [
        vueExports.renderSlot(e.$slots, "default")
      ], 512);
    }
...
`));
    ...
    const pp = {
      ...
      methods: {
         ...
         */
        toggleColumn(e) {
          const t = !this.columnIsVisible(e), r = fp(this.columns, (i) => i.can_be_hidden ? i.key === e ? t : this.visibleColumns.includes(i.key) : true);
    ...
    function bp(e, t, r, n, i, s) {
      return vueExports.openBlock(), vueExports.createElementBlock("div", yp, [
        vueExports.renderSlot(e.$slots, "default")
      ], 512);
    }
  ...
  `, document.head.appendChild(t);
      ...
      install: (e, t) => {
        ...
        t.suppress_compile_errors && (e.config.compilerOptions.onError = (n) => {
          import("./assets/CompilerErrorMessages-4a55bbec-4a55bbec.js").then((i) => {
            console.error({
    ...
    Cp(createServer, renderToString, (props) => {
